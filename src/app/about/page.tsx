    ...
    <main className="min-h-screen bg-surface-bright py-16">
      <div className="mx-auto w-full max-w-6xl px-6">
        <div className="text-center mb-12">
          ...
          <h1 className="text-5xl font-bold text-slate-950 mb-4">About Us</h1>
        ...
        <div className="grid gap-6 lg:grid-cols-[1.6fr_1fr] mb-10">
          <div className="rounded-[2rem] border border-slate-200 bg-white p-10 shadow-2xl">
            ...
            <h2 className="text-3xl font-bold text-slate-950 mb-4">Un producto educativo diseñado para aprender álgebra lineal.</h2>
          ...
          <div className="rounded-[2rem] border border-slate-200 bg-white p-10 shadow-2xl">
            <div className="rounded-[1.75rem] overflow-hidden bg-slate-900">
              <div className="h-72 bg-[url('https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?auto=format&fit=crop&w=900&q=80')] bg-cover bg-center" />
              <div className="p-6 bg-slate-950 text-white">
                <p className="text-xs uppercase tracking-[0.28em] text-teal-300 font-semibold mb-3">Interactive Suite</p>
                <p className="text-sm text-slate-300 leading-6">
                  Interfaz limpia, colores suaves y tarjetas bien definidas para que cada paso sea fácil de seguir.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="rounded-[2rem] border border-slate-200 bg-white p-10 shadow-2xl">
          <div className="grid gap-6 lg:grid-cols-[1fr_1fr] items-center">
            <div>
              ...
              <p className="text-slate-600 leading-8">
                Nuestro equipo de desarrollo y diseño trabajó en cada detalle para ofrecer una experiencia de aprendizaje fluida y agradable.
              </p>
            </div>
            <div className="grid gap-3 sm:grid-cols-2">
              {['Hollmer Moncada', 'Jerenimo Muñoz', 'Cristian Villamarin', 'Mariana Rivera'].map((name) => (
